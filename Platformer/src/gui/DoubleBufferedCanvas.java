...
/**
* This abstract class acts as an easy implementation of a 
...
public abstract class DoubleBufferedCanvas extends Canvas {
	...
	* its BufferStrategy.
	* 
	* @pre TemplateCanvas MUST be added to its container before this method is called! 
	...
	*/
	public void createAndSetBuffer() {
		try {
			...
			System.out.print("Error: Canvas must be added to JFrame before createAndSetBuffer() can be called!");
			System.exit(-1);
		}
	}
